...
class Dcase2024task3:
    ...
    def __init__(self, root_dir):
        ...
        self.label_set = ['Female speech, woman speaking', 'Male speech, man speaking', 'Clapping', 'Telephone', 'Laughter', 'Domestic sounds', \
            'Walk, footsteps', 'Door, open or close', 'Music', 'Musical instrument', 'Water tap, faucet', 'Bell', \
                'Knock']
