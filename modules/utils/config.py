...
from utils.datasets import Dcase2024task3, Dcase2020task3
...
def get_dataset(dataset_name, root_dir):
    assert dataset_name == 'dcase2024task3' or dataset_name == 'dcase2020task3', \
        "Dataset name '{}' is not 'dcase2024task3' or 'dcase2020task3'".format(dataset_name)
