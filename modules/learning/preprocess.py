...
class Preprocessor:
    ...
    def __init__(self, args, cfg, dataset):
        ...
        # Path for dataset
        hdf5_dir = Path(cfg['hdf5_dir'])  # /dataset/dataset_processed
        ...
        data_h5_dir = hdf5_dir.joinpath('data')
        self.data_h5_dir_list = [
            data_h5_dir.joinpath(args.dataset_type).joinpath('foa'),  # /dataset/dataset_processed/foa_dev
            data_h5_dir.joinpath(args.dataset_type).joinpath('mic')   # /dataset/dataset_processed/mic_dev      
        ]
